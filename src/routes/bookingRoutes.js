...
router.get("/get-driver-customer-by-id/:id", bookingController.getBookingDriverCustomerById);
...
router.post(
  "/assign-future-booking",
  bookingController.assignFutureBookingToDriver,
);
