...
exports.addAttribute = async (req, res) => {
    try {
        ...
        const newAttribute = await DriverAttribute.create(attribute_name, short_name, company_id);
...
exports.updateAttribute = async (req, res) => {
    try {
        ...
        const updated = await DriverAttribute.update(id, attribute_name, short_name);
