...
const DriverAttribute = {
  ...
  getAll: async (company_id) => {
    ...
    if (company_id) {
      query =
        "SELECT id, attribute_name, short_name FROM driver_attributes WHERE company_id = $1 ORDER BY id ASC;";
      params = [company_id];
    } else {
      query =
        "SELECT id, attribute_name, short_name FROM driver_attributes ORDER BY id ASC;";
      params = [];
    }
  ...
  getById: async (id) => {
    const query =
      "SELECT id, attribute_name, short_name FROM driver_attributes WHERE id = $1;";
